...
A = NeuronGroup(name="A", num_circuits=sizes[0], num_error_pairs=s_pairs[0], pos_error_to_head=pos_error_to_head[0],
                ...
                log_head_out=log_amplitudes, log_neg_error_out=log_amplitudes, log_pos_error_out=log_amplitudes,
                log_noise_amplitude=log_noise_amplitude, log_weights=log_weights, log_neg_error_diff=log_s_diff)
